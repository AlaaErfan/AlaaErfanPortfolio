...
const SkillsPage: React.FC = () => {
  ...
  const skillCategories = {
    ...
    backend: {
      ...
      skills: [
        { 
          name: 'FastAPI & Flask Systems', 
          description: 'Building and deploying secure APIs with JWT and database integration',
          technologies: ['FastAPI', 'Flask', 'Uvicorn', 'Gunicorn'],
          experience: '1+ years'
        },
        { 
          name: 'Database Architecture & Querying', 
          description: 'End-to-end design of scalable relational database systems',
          technologies: ['Oracle', 'SQL Server', 'PostgreSQL', 'SQLAlchemy'],
          experience: '1+ years'
        },
      { 
      name: 'Node.js & Express.js APIs', 
      description: 'Scalable RESTful APIs, authentication, and middleware using Node.js with Express',
      technologies: ['Node.js', 'Express.js', 'JWT'],
      experience: '1+ years'
    },
        { 
          name: 'Authentication & Payment Integration', 
          description: 'JWT auth, API tokens, and secure payment workflows with real-time services',
          technologies: ['JWT', 'OAuth2', 'Paymob', 'bcrypt'],
          experience: '1+ years'
        }
      ]
    },
    data: {
      ...
      skills: [
        { 
          ...
          technologies: ['Pandas', 'Excel', 'Power BI', 'Plotly'],
          experience: '1+ years'
        },
        { 
    ...
    programming: {
      ...
      skills: [
        { 
          ...
          description: 'AI, scripting, web APIs, automation, and more using Python',
          technologies: ['Django', 'Flask', 'FastAPI', 'Celery'],
          experience: '1+ years'
        },
        { 
          name: 'JavaScript & React', 
          description: 'Frontend integration for AI systems and dashboards',
  ...
  const certifications = [
    { title: 'IBM AI Analyst Mastery Award', issuer: 'IBM', year: '2021' },
    { title: 'Google Data Analytics Certificate', issuer: 'Google (Coursera)', year: '2022' },
    { title: 'Deep Learning Specialization', issuer: 'DeepLearning.AI', year: '2023' },
    { title: 'Machine Learning Specialization', issuer: 'DeepLearning.AI', year: '2023' },
    { title: 'Google Digital Marketing & E-Commerce', issuer: 'Google (Coursera)', year: '2022' },
    { title: 'Google Project Management Certificate', issuer: 'Google (Coursera)', year: '2022' }
  ];
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Comprehensive technical expertise across AI, backend development, data science & cloud deployment
            </p>
          </motion.div>
          ...
          >
            <a
              href="https://drive.google.com/file/d/1wQT-SZzTEemLFoRK0U3aPnpZub2pXlAO/view?usp=sharing"
              target="_blank"
            ...
            <div className="bg-zinc-900 rounded-lg p-8 border border-zinc-800">
              ...
              <div className="grid lg:grid-cols-2 gap-8">
                {skillCategories[activeCategory as keyof typeof skillCategories].skills.map((skill) => (
                  <div key={skill.name} className="bg-zinc-800 rounded-lg p-6 border border-zinc-700">
