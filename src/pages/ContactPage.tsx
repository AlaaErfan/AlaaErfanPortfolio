  ...
  const contactInfo = [
    {
      icon: Mail,
      label: 'Email',
      value: 'eng.alaaerfan2001@gmail.com',
      href: 'mailto:eng.alaaerfan2001@gmail.com',
  ...
  const socialLinks = [
    {
      ...
      label: 'GitHub',
      value: '@AlaaErfan',
      href: 'https://github.com/AlaaErfan',
    ...
    },
    {
      ...
      label: 'LinkedIn',
      value: '/in/alaaerfan',
      href: 'https://www.linkedin.com/in/alaaerfan/',
    ...
    },
    {
      ...
      href: 'https://www.credly.com/users/alaa-erfan',
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Ready to collaborate on AI projects or discuss opportunities? Let's connect and build something amazing together!
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              <h2 className="text-3xl font-bold text-white mb-8">Connect Online</h2>
              <div className="space-y-6">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          <h3 className="text-lg font-semibold text-white mb-1">{social.label}</h3>
                          <p className="text-gray-300 font-medium mb-1">{social.value}</p>
          ...
          >
            <div className="bg-zinc-900 rounded-lg p-8 border border-zinc-800">
              ...
              <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
                I'm always interested in discussing AI projects, backend development opportunities, 
                and innovative tech solutions. Whether you have a specific project in mind or just want to explore possibilities, 
